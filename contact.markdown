	...
	<div class="container">
		<div class="row">
			<div class="col-md-10 offset-md-1">
				...
				<div id="free-thanks" style="display: none;">
					...
					<div class="row" style="margin: 0;">
						<div class="col-md-7 pl-0 pb-3 pr-3">
							<h4 class="mt-3">✅ Thanks for contacting us.</h4>
							<p><strong>A Taekwondo University team member will reach out very soon.</strong></p>
							<p class="mb-2"><strong>Got Questions?</strong></p>
				...
				<p style="text-align: center; color: #666; margin: 2em 0 0 0; font-size: 13.5px; line-height: 1.5em;">By providing your number you consent to receive marketing/promotional/notification messages from Taekwondo university, to opt-out reply STOP at any moment. Msg & Data rates may apply.</p>
			</div>
		</div>
		...
		<div class="row" id="free-includes">
			<div class="col-md-10 offset-md-1">
				<div class="free-includes-content">
					<h3 class="mb-2 text-center">We're located next to Piggly Wiggly in Olive Branch</h3>
					<div class="row" style="margin: 0;">
						<div class="col-12">
							<p class="top-brow yellow"></p>
