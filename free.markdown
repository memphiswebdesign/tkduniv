    ...
    <div class="row">
      <div class="col-md-10 offset-md-1">
        ...
        <div id="tkd-lead-thanks" class="d-none">
          <p class="lead">
            Thanks <strong><span data-lead-first></span> <span data-lead-last></span></strong> — we got your request for the
            <strong><span data-lead-interest></span></strong> program.
          </p>
          <p class="mb-0">
            We’ll reach out shortly to get your free class scheduled.
          </p>
        </div>
        <!-- Thanks END -->
      </div>
