      ...
      <div class="col-md-10 offset-md-1">
    		<form name="tkd-lead" method="POST" data-netlify="true" data-netlify-honeypot="bot-field" id="tkd-lead-form">
    		  ...
    		  <p style="display:none;">
    		    <label>Don’t fill this out: <input type="text" name="bot-field" /></label>
    		  </p>
          ...
          <p class="mb-0 mt-3">
              <label style="display:flex; gap:10px; align-items:flex-start;">
                <input
                  ...
                  value="yes"
                  required
                  style="position:relative; top:2px; flex:0;"
                />
        ...
        <div id="tkd-lead-thanks" class="d-none">
          <div class="lead">
            <h2 id="hi">Hi, <strong><span data-lead-first></span> <span data-lead-last></span></strong> <span class="emoji-wave">👋</span></h2>
            <p class="mb-1"><strong>Your Martial Arts Journey Starts Now! 🥋👊💥</strong></p>
            <p class="mb-1">We got your request for the <strong><span data-lead-interest></span></strong> program.</p>
            <p class="mb-1">📬 We just sent you an email with a link to choose the class time that works best for you.</p>
            <p class="mb-1">We’ll reach out shortly to answer any questions you may have about your 1st intro class.</p>
            <h4 class="mt-3 mb-0">Ready to schedule?</h4>
            <p class="mt-0 mb-1">Select program, pick date &amp; time:</p>
            <div class="btn-set">
              <a class="d-inline-flex align-items-center btn btn-md btn-outline-dark mb-2" href="https://sparkpages.io/scheduler5/?l=_aGb&cal=_Y20&c=&s=" target="_blank">Little Warriors (4-6 years old)</a>
              <a class="d-inline-flex align-items-center btn btn-md btn-outline-dark mb-2" href="https://sparkpages.io/scheduler5/?l=_aGb&cal=_Z20&c=&s=" target="_blank">Kids Taekwondo (7-12 years old)</a>
              <a class="d-inline-flex align-items-center btn btn-md btn-outline-dark mb-2" href="https://sparkpages.io/scheduler5/?l=_aGb&cal=_r50&c=&s=" target="_blank">Adult Taekwondo (13+ years old)</a>
            </div>
            <h3 class="mt-3">What to expect:</h3>
            <ul class="pl-4">
              <li>🥋 Uniform + Belt Provided upon arrival</li>
              <li>⏱️ Arrive 15 minutes early, as you'll receive a facility tour, meet the staff &amp; get ready for your 1st class.</li>
            </ul>
          </div>
        </div>
        <!-- Thanks END -->
  ...
  (function () {
    ...
    form.addEventListener("submit", async function (e) {
      ...
      try {
        ...
        // but we’ll ensure it’s present in the POST body too.
        ...
        console.error(err);
        alert("Hmm — something didn’t submit correctly. Please try again.");
      }
    });
  })();
